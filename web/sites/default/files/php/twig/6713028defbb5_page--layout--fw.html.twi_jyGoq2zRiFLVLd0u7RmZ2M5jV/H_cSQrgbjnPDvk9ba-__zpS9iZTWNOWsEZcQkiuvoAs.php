...
class __TwigTemplate_752c11c4224a4e87ba7447d92273de74 extends Template
{
...
\t   ";
        // line 10
        yield from         $this->loadTemplate(($context["header_skin"] ?? null), "themes/custom/gavias_daudo/templates/page/page-layout/page--layout--fw.html.twig", 10)->unwrap()->yield($context);
        // line 11
        yield "\t\t
\t\t";
        // line 12
...
\t\t\t\t\t\t\t\t";
            // line 44
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "before_content", [], "any", false, false, true, 44), 44, $this->source), "html", null, true);
            yield "
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
...
\t\t\t\t\t";
        // line 55
        yield from         $this->loadTemplate("@gavias_daudo/page/main-no-sidebar.html.twig", "themes/custom/gavias_daudo/templates/page/page-layout/page--layout--fw.html.twig", 55)->unwrap()->yield($context);
        // line 56
        yield "\t\t\t\t</div>
\t\t\t</div>
...
\t\t\t\t\t\t\t ";
            // line 71
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "after_content", [], "any", false, false, true, 71), 71, $this->source), "html", null, true);
            yield "
\t\t          \t</div>
\t        \t\t</div>
\t\t\t\t</div>
...
\t";
        // line 80
        yield from         $this->loadTemplate("@gavias_daudo/page/footer.html.twig", "themes/custom/gavias_daudo/templates/page/page-layout/page--layout--fw.html.twig", 80)->unwrap()->yield($context);
        // line 81
        yield "</div>

";
        // line 83
        yield from         $this->loadTemplate("@gavias_daudo/page/parts/quick-side.html.twig", "themes/custom/gavias_daudo/templates/page/page-layout/page--layout--fw.html.twig", 83)->unwrap()->yield($context);
    ...
    {
        return new Source("", "themes/custom/gavias_daudo/templates/page/page-layout/page--layout--fw.html.twig", "/app/web/themes/custom/gavias_daudo/templates/page/page-layout/page--layout--fw.html.twig");
    }
