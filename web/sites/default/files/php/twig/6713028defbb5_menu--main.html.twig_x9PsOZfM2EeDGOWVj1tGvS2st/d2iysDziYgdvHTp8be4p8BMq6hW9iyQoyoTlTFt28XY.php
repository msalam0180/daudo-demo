...
class __TwigTemplate_de8ffe07ea9f09cc8facabea67037da3 extends Template
{
...
($context["class_columns"] ?? null)];
        ...
        <a data-link_id=\"link-";
                    ...
                    // line 62
                    yield "          ";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, Twig\Extension\CoreExtension::trim($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "title", [], "any", false, false, true, 62), 62, $this->source)), "html", null, true);
        ...
        ";
                    ...
                    if (((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 64), "gva_layout", [], "any", false, false, true, 64) == "menu-block") && (($context["menu_level"] ?? null) == 0))) {
                        ...
                        yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "gva_block_content", [], "any", false, false, true, 65), 65, $this->source));
                        yield "</div>
        ";
                    }
                    // line 66
        ...
        ";
                    ...
                    if (CoreExtension::getAttribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 67)) {
                        yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(CoreExtension::callMacro($macros["menus"], "macro_menu_links", [CoreExtension::getAttribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 67), ($context["attributes"] ?? null), (($context["menu_level"] ?? null) + 1)], 67, $context, $this->getSourceContext()));
                    }
                    // line 68
                    yield "      </li>
    ";
  ...
  ";
    ...
    {
        return new Source("", "themes/custom/gavias_daudo/templates/navigation/menu--main.html.twig", "/app/web/themes/custom/gavias_daudo/templates/navigation/menu--main.html.twig");
    }
