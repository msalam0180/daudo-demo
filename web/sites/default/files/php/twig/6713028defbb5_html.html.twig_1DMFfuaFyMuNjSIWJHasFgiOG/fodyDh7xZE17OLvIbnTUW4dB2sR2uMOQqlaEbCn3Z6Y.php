...
class __TwigTemplate_84f57823ed76cc7fdd24eb57d9533c68 extends Template
{
...
($context["node_id"] ?? null)) ? (("node-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["node_id"] ?? null), 53, $this->source)))) : (""))];
  ...
  <body";
    ...
    ";
        // line 72
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["page_top"] ?? null), 72, $this->source), "html", null, true);
        yield "
    ";
        // line 73
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["page"] ?? null), 73, $this->source), "html", null, true);
        yield "
    ";
        // line 74
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["page_bottom"] ?? null), 74, $this->source), "html", null, true);
        yield "
    ...
    ";
        ...
        if (($context["addon_template"] ?? null)) {
            ...
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["save_customize_permission"] ?? null), 78, $this->source), "html", null, true);
            yield "\">
         ";
            // line 79
...
";
    ...
    {
        return new Source("", "themes/custom/gavias_daudo/templates/page/html.html.twig", "/app/web/themes/custom/gavias_daudo/templates/page/html.html.twig");
    }
